defmodule Dsa.Lore.FWeapon do
  ...
  @fields ~w(id name tp_dice tp_bonus rw1 rw2 rw3 lz combat_skill_id)a
  ...
  def entries do
    ...
    |> Enum.map(fn {id, combat_skill_id, name, tp_dice, tp_bonus, rw1, rw2, rw3, lz} ->
      %{id: id, combat_skill_id: combat_skill_id, name: name, tp_dice: tp_dice, tp_bonus: tp_bonus, rw1: rw1, rw2: rw2, rw3: rw3, lz: lz}
    end)
  end
end
