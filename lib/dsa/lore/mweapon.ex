defmodule Dsa.Lore.MWeapon do
  ...
  @fields ~w(id name tp_dice tp_bonus ge kk ls at_mod pa_mod rw combat_skill_id)a
  ...
  def entries do
    ...
    |> Enum.map(fn {id, combat_skill_id, name, tp_dice, tp_bonus, ge, kk, ls, at_mod, pa_mod, rw} ->
      %{
        id: id,
        name: name,
